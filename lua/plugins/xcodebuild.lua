    ...
    config = function()
      require("xcodebuild").setup({
        ...
        console_logs = {
          ...
          filter_line = function(_) -- filter each line of logs
            return true
          end,
        },
        marks = {
        ...
        project_manager = {
          ...
          should_update_project = function(_) -- path can lead to directory or file
            -- it could be useful if you mix Xcode project with SPM for example
            return true
          end,
          project_for_path = function(_)
        ...
        highlights = {
          -- Link to diagnostic highlights for theme consistency (works with light/dark)
          XcodebuildCoverageReportOk = "DiagnosticOk",
          XcodebuildCoverageReportWarning = "DiagnosticWarn",
          XcodebuildCoverageReportError = "DiagnosticError",

          -- Coverage signs in gutter
          XcodebuildCoverageFull = "DiagnosticOk",
          XcodebuildCoveragePartial = "DiagnosticWarn",
          XcodebuildCoverageNone = "DiagnosticError",

          -- Test explorer & signs
          XcodebuildTestSuccessSign = "DiagnosticOk",
          XcodebuildTestFailureSign = "DiagnosticError",
          XcodebuildTestSuccessText = "DiagnosticOk",
          XcodebuildTestFailureText = "DiagnosticError",

          -- Build progress
          XcodebuildProgressText = "Comment",
        },
      })
    end,
  },
